...
<!-- Mirrored from zoyothemes.com/kevix/team-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2019 07:12:32 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    <div class="team-details rounded p-4">
                        ...
                        <h6 class="text-custom">PHP & Web Developer</h6>
                        ...
                        <div class="team-details-add text-muted mb-3">
                            <div class="team-details-item">
                                ...
                                <p class="pt-1">+91 9876 5432 10</p>
                            </div>
                        </div>
                        <div class="team-details-add text-muted mb-3">
                            <div class="team-details-item">
                                ...
                                <p class="pt-1">2135 Nicholas Street Home, KS 66438</p>
                            </div>
                        </div>
                        <div class="team-details-add text-muted mb-3">
                            <div class="team-details-item">
                                ...
                                <p class=" pt-1">Youremail@gmail.com</p>
                            </div>
                        </div>
                        <div class="team-details-add text-muted mb-3">
                            <div class="team-details-item">
                                ...
                                <p class="pt-1">Yourwebsitename.co.in</p>
                            </div>
                        </div>

                        <div class="team-details-social-icon mt-4">
                            <h6 class="text-muted mb-0">Share it :</h6>
                            <ul class="list-inline mb-0 mt-3">
                                <li class="list-inline-item"><a href="#" class="text-custom"><i class="mdi mdi-facebook"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="text-custom"><i class="mdi mdi-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="text-custom"><i class="mdi mdi-linkedin"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="text-custom"><i class="mdi mdi-paypal"></i></a></li>
                                <li class="list-inline-item"><a href="#" class="text-custom"><i class="mdi mdi-whatsapp"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="tab-pane fade" id="skill" role="tabpanel" aria-labelledby="skill-tab">
                        <div class="skill">
                            <div>
                                <h6 class="text-muted text-uppercase mb-2">Html</h6>
                                <div class="progress">
                                    <div class="progress-bar" style="width:90%;">
                                        <div class="progress-value text-muted h6">90%</div>
                                    </div>
                                </div>
                            </div>

                            <div class="mt-5">
                                <h6 class="text-muted text-uppercase mb-2">Css</h6>
                                <div class="progress">
                                    <div class="progress-bar" style="width:70%;">
                                        <div class="progress-value text-muted h6">70%</div>
                                    </div>
                                </div>
                            </div>

                            <div class="mt-5">
                                <h6 class="text-muted text-uppercase mb-2">Javascript</h6>
                                <div class="progress">
                                    <div class="progress-bar" style="width:50%;">
                                        <div class="progress-value text-muted h6">50%</div>
                                    </div>
                                </div>
                            </div>
                        
                            <div class="mt-5">
                                <h6 class="text-muted text-uppercase mb-2">Wordpress</h6>
                                <div class="progress">
                                    <div class="progress-bar" style="width:80%;">
                                        <div class="progress-value text-muted h6">80%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    ...
                                    <p class="mb-0 text-white-70">Web Designer, USA</p>
                        ...
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    ...
                                    <p class="mb-0 text-white-70">Graphic Designer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-twitter"></i></a></li>
                        ...
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    ...
                                    <p class="mb-0 text-white-70">UI/UX Developer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-twitter"></i></a></li>
                        ...
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    ...
                                    <p class="mb-0 text-white-70">PHP Developer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-twitter"></i></a></li>
