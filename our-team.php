...
<!-- Mirrored from zoyothemes.com/kevix/our-team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2019 07:12:14 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="home-page-title text-center">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center bg-transparent">
                                        ...
                                        <li class="breadcrumb-item  active" aria-current="page"><a href="our-team.html" class="text-custom">Our Team</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="our-team-box mt-2 mb-4">
                        <div class="team-img">
                            ...
                            <div class="our-team-name text-center">
                                <h6 class="mb-0 text-white">Aaron Smith</h6>
                            </div>
                        </div>
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    <h5 class="text-white mb-0">Aaron Smith</h5>
                                    <p class="mb-0 text-white-70">Web Developer, USA</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="our-team-box mt-2 mb-4">
                        <div class="team-img">
                            ...
                            <div class="our-team-name text-center">
                                <h6 class="mb-0 text-white">Paul Geist</h6>
                            </div>
                        </div>
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    <h5 class="text-white mb-0">Paul Geist</h5>
                                    <p class="mb-0 text-white-70">Web Developer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="our-team-box mt-2 mb-4">
                        <div class="team-img">
                            ...
                            <div class="our-team-name text-center">
                                <h6 class="mb-0 text-white">Ruth Bernal</h6>
                            </div>
                        </div>
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    <h5 class="text-white mb-0">Ruth Bernal</h5>
                                    <p class="mb-0 text-white-70">Web Designer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="our-team-box mt-2 mb-4">
                        <div class="team-img">
                            ...
                            <div class="our-team-name text-center">
                                <h6 class="mb-0 text-white">Roy Judge</h6>
                            </div>
                        </div>
                        <div class="our-team-overlay">
                            <div class="item-content text-white text-center p-2">
                                <div class="item-desc">
                                    <h5 class="text-white mb-0">Roy Judge</h5>
                                    <p class="mb-0 text-white-70">Graphic Designer, USA</p>
                                    <div class="our-team-box-border mt-3 mb-3"></div>
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item m-0"><a href="#" class="our-team-icons"><i class="mdi mdi-facebook"></i></a></li>
...
<!-- Mirrored from zoyothemes.com/kevix/our-team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2019 07:12:32 GMT -->
</html>
